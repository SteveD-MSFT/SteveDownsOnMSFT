...
Invoke-Command -VMName $your_VM_name -Credential $cred -ScriptBlock {New-NetIPAddress -InterfaceAlias "NIC1" -IPAddress 172.16.50.101 -PrefixLength 12 -AddressFamily IPv4 -DefaultGateway 172.16.0.1 }
