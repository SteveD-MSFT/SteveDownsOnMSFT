...
$username = "lab\scdadmin"
$password = ConvertTo-SecureString $password -AsPlainText -Force
$credential = New-Object System.Management.Automation.PSCredential($username, $password)

# Specify the remote computer's IP
$computerIP = $hciIP

# Start the remote session
$session = New-PSSession -ComputerName $computerName -Credential $credential

# To execute commands in the remote session, use Invoke-Command
# For example, to get the list of running processes:
Invoke-Command -Session $session -ScriptBlock { Get-Process }

# When you're done, don't forget to remove the session
